...
import { BookOpen, MonitorPlay, Users, Zap, CheckCircle2, ArrowRight, X, User, Lock, Eye, Plus, Trash2, Key, LogOut, Search, Edit2, MoreVertical, ShieldCheck } from 'lucide-react';
            ...
            {authMode === 'login' ? (
              ...
              <form className="space-y-4" onSubmit={(e) => { 
                ...
                <div className="relative">
                  ...
                  <input type="password" required className="block w-full pl-10 pr-10 py-2.5 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all text-sm" placeholder="Mật khẩu" />
                  <div className="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer">
                    <Eye className="h-5 w-5 text-slate-400 hover:text-slate-600" />
                  </div>
                </div>
        ...
        <section className="relative pt-32 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden bg-slate-900">
          ...
          <div className="relative max-w-7xl mx-auto text-center z-10">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              >
                Đăng ký dùng thử <ArrowRight className="w-5 h-5" />
              </button>
              <button className="flex items-center justify-center gap-2 bg-white/10 text-white border border-white/20 px-8 py-4 rounded-full text-lg font-medium hover:bg-white/20 transition-all backdrop-blur-sm">
                Tìm hiểu thêm
              </button>
            </div>
        ...
        <section id="san-pham" className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-slate-900 mb-4">Sản phẩm của chúng tôi</h2>
              <p className="text-slate-600 max-w-2xl mx-auto">Hệ sinh thái giáo dục toàn diện đáp ứng mọi nhu cầu của thời đại số.</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-slate-50 rounded-2xl p-8 border border-slate-100 hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Lớp học ảo tương tác</h3>
                <p className="text-slate-600">Nền tảng học trực tuyến video chất lượng cao, tích hợp bảng trắng, chia sẻ màn hình và điểm danh tự động.</p>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-8 border border-slate-100 hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Giáo viên chuyển đổi số trong học tập</h3>
                <p className="text-slate-600">Hệ thống quản lý khóa học, giao bài tập, chấm điểm tự động và theo dõi tiến độ học tập của học sinh.</p>
              </div>
              ...
              <div className="bg-slate-50 rounded-2xl p-8 border border-slate-100 hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Trợ giảng AI</h3>
                <p className="text-slate-600">Tích hợp trí tuệ nhân tạo hỗ trợ giải đáp thắc mắc 24/7, gợi ý lộ trình học tập cá nhân hóa.</p>
              </div>
            </div>
          </div>
        </section>
