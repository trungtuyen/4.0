        ...
        <section id="bang-gia" className="bg-white py-20">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <div className="relative rounded-3xl border border-indigo-500 bg-indigo-600 p-8 text-white shadow-xl md:-translate-y-3"><div className="absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 px-4 py-1 text-xs font-bold uppercase">Phổ biến</div><h3 className="mb-2 text-lg font-semibold">Chuyên nghiệp</h3><p className="mb-6 text-sm text-indigo-200">AI giáo dục + công cụ nâng cao</p><div className="mb-6"><span className="text-4xl font-bold">499.000đ</span><span className="text-indigo-200">/tháng</span></div><ul className="mb-8 space-y-3 text-indigo-50"><li className="flex gap-2"><CheckCircle2 className="h-5 w-5 text-indigo-200" />AI Trợ lý giáo viên</li><li className="flex gap-2"><CheckCircle2 className="h-5 w-5 text-indigo-200" />Tích hợp NLS, AI, hòa nhập</li></ul><button onClick={props.onTeacherRegister} className="w-full rounded-xl bg-white px-4 py-3 font-medium text-indigo-600 hover:bg-slate-50">Dùng thử</button></div>
